...
const { analysisPrompts, interviewFormattingPrompts, getInterviewTemplate, transcriptEvaluationPrompts, botRecommendationPrompts } = require('../services/geminiPrompts.js');

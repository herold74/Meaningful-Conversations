    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <div style="margin-top: 20px;">
                    <h3 style="color: #667eea; margin-bottom: 10px;">${isGerman ? '🏆 Erfolge' : '🏆 Achievements'}</h3>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px;">
                ...
                <a href="mailto:gherold@manualmode.at" style="color: #667eea;">gherold@manualmode.at</a>
            </p>
        </div>
    </div>
</body>

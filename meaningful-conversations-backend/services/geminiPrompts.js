            ...
            items: {
                ...
                properties: {
                    ...
                    primary: {
                        ...
                        properties: {
                            botId: { type: 'STRING', description: 'The exact bot ID (e.g., "ava-strategic", "chloe-structured-reflection").' },
                    ...
                    secondary: {
                        ...
                        properties: {
                            botId: { type: 'STRING', description: 'The exact bot ID (e.g., "nexus-goal-path-solution", "victor-systemic-coaching").' },
...
- Nobody (nexus-goal-path-solution, guest): Pragmatic management advisor and communication strategist, GPS method. For: management and communication topics, concrete problem-solving, next steps, conversation preparation.
...
- Nobody (nexus-goal-path-solution, guest): Pragmatischer Management-Berater und Kommunikationsstratege, GPS-Methode. Für: Management- und Kommunikationsthemen, konkretes Problem-Solving, nächste Schritte, Gesprächsvorbereitung.

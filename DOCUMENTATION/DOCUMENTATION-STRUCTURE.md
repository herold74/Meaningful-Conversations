...
- **VERGLEICH-SAM-GABRIELLE-VICTOR.md** - **Detaillierter Methodenvergleich** Vier-Phasen (Gabrielle) · zukunftsorientiert (Sam) · systemisch (Victor): Einheit der Arbeit, Sequenz, Contracting, typische Mix-ups, Practice-Lab-Hinweise. Kurzform: Vergleichslinse im Cheatsheet.
- **CRISIS-HELPLINES.md** - **Kuratierte kostenlose Krisenhotlines** AT/DE/CH/CA (national + Land/Provinz), Quellen und Review-Datum. Runtime: `crisisResources.js` in allen Coach-Prompts.

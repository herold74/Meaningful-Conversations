...
| File | Changes |
|------|---------|
| `setup-alternative-env.sh` | • Added prompts for MariaDB root password<br>• Updated user password prompts<br>• Updated summary output |
...
| `QUICK-START-ALTERNATIVE-SERVER.md` | ✅ Updated for MariaDB & Pod |

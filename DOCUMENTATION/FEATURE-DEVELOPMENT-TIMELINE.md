...
- ⬜ **New Bots (Premium Features)**
  - **client exact language Bot** (David Grove): Uses client's exact metaphors without interpretation. Focus on exploring the architecture of inner landscapes.
...
User:  6 Coaches    Victor+Seasonal     Personality+DPC/DPFL   Coaching Frameworks
       Chat+Voice   Theme Switching     Transcript+Gloria      client exact language
...
- **client exact language Bot** (David Grove) — Premium feature, new bot

...
# Test it works
ssh root@91.99.193.87 "echo 'Success!'"
```
...
ssh root@91.99.193.87 'cd /opt/manualmode-staging && podman-compose -f podman-compose-staging.yml ps mariadb'

# Check database logs
ssh root@91.99.193.87 'cd /opt/manualmode-staging && podman-compose -f podman-compose-staging.yml logs mariadb'
...
```bash
# Check if database is running
ssh root@91.99.193.87 'cd /opt/manualmode-production && podman-compose -f podman-compose-production.yml ps mariadb'

# Check database logs
ssh root@91.99.193.87 'cd /opt/manualmode-production && podman-compose -f podman-compose-production.yml logs mariadb'
...
# Restart backend
ssh root@91.99.193.87 'cd /opt/manualmode-staging && podman-compose -f podman-compose-staging.yml restart backend'
```
...
# Restart backend
ssh root@91.99.193.87 'cd /opt/manualmode-production && podman-compose -f podman-compose-production.yml restart backend'
```
...
ssh root@91.99.193.87 'netstat -tulpn | grep -E ":80 |:443 "'

# Check nginx status (handles all external traffic)
ssh root@91.99.193.87 'systemctl status nginx'
ssh root@91.99.193.87 'nginx -t'
...
alias logs-staging="ssh root@91.99.193.87 'cd /opt/manualmode-staging && podman-compose -f podman-compose-staging.yml logs -f'"
alias status-staging="ssh root@91.99.193.87 'cd /opt/manualmode-staging && podman-compose -f podman-compose-staging.yml ps'"

# Production aliases
alias deploy-prod="cd /path/to/project && make deploy-manualmode-production"
alias logs-prod="ssh root@91.99.193.87 'cd /opt/manualmode-production && podman-compose -f podman-compose-production.yml logs -f'"
alias status-prod="ssh root@91.99.193.87 'cd /opt/manualmode-production && podman-compose -f podman-compose-production.yml ps'"
```
...
watch -n 5 "ssh root@91.99.193.87 'cd /opt/manualmode-staging && podman-compose -f podman-compose-staging.yml ps'"

# Tab 3: Check resources
ssh root@91.99.193.87 "podman pod stats meaningful-conversations-staging"

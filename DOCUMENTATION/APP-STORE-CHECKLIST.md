...
- [ ] Xcode version synced with package.json — **2.5.6:** `MARKETING_VERSION=2.5.6`, `CURRENT_PROJECT_VERSION=26` (nach `npm run build && npx cap sync ios`, Stand 2026-08-09)
...
- [ ] RevenueCat: import product + add to default offering (**required for iOS paywall — empty offering shows „In-App-Käufe nicht verfügbar“**) — **done 2026-08-03** (`premium_plus_monthly` in `default`)

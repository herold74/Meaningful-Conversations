...
export const BOTS: Bot[] = [
    ...
    },
    {
        id: 'kenji-resilience',
        name: 'Kenji',
        description: 'A coach helping you build resilience and inner strength for challenges.',
        description_de: 'Ein Coach, der Ihnen hilft, Widerstandsfähigkeit und innere Stärke für Herausforderungen aufzubauen.',

    ...
    return (
        <div className="w-full max-w-3xl mx-auto p-8 space-y-6 bg-white dark:bg-transparent border border-gray-300 dark:border-gray-700 my-10 animate-fadeIn">
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-4 leading-relaxed">
                <p>{t('about_p1')}</p>
                <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{t('about_mission_title')}</h2>
                <p>{t('about_mission_p1')}</p>
                <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{t('about_howitworks_title')}</h2>
                <p>{t('about_howitworks_p1')}</p>
            </div>
        </div>
    );
};

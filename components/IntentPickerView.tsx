...
const IntentPickerView: React.FC<IntentPickerViewProps> = ({ onSelect, isGuest, onSkipPermanently }) => {
  const { t } = useLocalization();

  return (
    <div className="flex flex-col items-center min-h-[85vh] px-4 sm:px-6 pt-10 pb-6 max-w-lg mx-auto">
      <motion.h1

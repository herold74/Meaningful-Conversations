      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg">
        ...
        {success ? (
            ...
            <div>
                ...
                required
                disabled={isLoading}
                className="mt-1 w-full p-3 bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-1 focus:ring-accent-primary disabled:opacity-50"
                autoCapitalize="none"
                autoCorrect="off"
                spellCheck="false"
                />

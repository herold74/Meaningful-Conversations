    ...
    return (
        <div className="w-full max-w-3xl mx-auto p-8 space-y-6 bg-white dark:bg-transparent border border-gray-300 dark:border-gray-700 my-10 animate-fadeIn">
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-4 leading-relaxed">
                <p>{t('terms_p1')}</p>
                <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{t('terms_conduct_title')}</h2>
                <p>{t('terms_conduct_p1')}</p>
                <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{t('terms_availability_title')}</h2>
                <p>{t('terms_availability_p1')}</p>
                 <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">{t('terms_liability_title')}</h2>

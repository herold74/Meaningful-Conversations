...
// Big5Result and Big5Facets are now defined in utils/bfi2.ts and re-exported above.
...
// BFI-2 data and scoring extracted to utils/bfi2.ts for reuse (e.g. OceanOnboarding)
import { BFI2_ITEMS, getBfi2Items, calculateBfi2 as calculateBfi2Shared, type Bfi2Variant, type Bfi2ItemDef, type Big5Result, type Big5Facets } from '../utils/bfi2';
export type { Big5Result, Big5Facets };
...
export const PersonalitySurvey: React.FC<PersonalitySurveyProps> = ({ 
  ...
  const calculateBfi2 = calculateBfi2Shared;

        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 items-stretch">
          {catalog.map((v) => (
            <button
              ...
              className="text-left h-full rounded-xl border border-border-secondary dark:border-border-primary bg-background-tertiary p-4 hover:border-accent-primary/60 hover:bg-accent-primary/5 transition-colors"
            >

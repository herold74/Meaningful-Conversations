...
- **Staging ↔ Production images:** Staging **2026-04-07** Build **11** (CORS www-Zwilling für `mc-beta`); Production auf dem Server zuletzt notiert **2026-04-05** Build **6** (`2.0.1`) — **Repo** hat danach u. a. **`02be385`** (Production-CORS); Deploy/Verifikation ausstehend bis bestätigt. Bei Cutover kurz Sessions möglich (Deploy-Playbook).

...
2. **Bot-Auswahl:**
   ...
   - **NICHT** "Nobody" (nexus-goal-path-solution) - dieser ist explizit ausgeschlossen
...
**Setup:**
- Bot: "Nobody" (nexus-goal-path-solution)
...
2. **Bot auswählen:**
   ...
   - **NICHT** Nobody (nexus-goal-path-solution)
...
2. Bot ist "Nobody" (nexus-goal-path-solution)
